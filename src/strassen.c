...
Matrix strassen_algorithm(Matrix a, Matrix b) {
  ...
  Matrix p1 = strassen_algorithm(a11, subtract_matrices(b12, b22));
  Matrix p2 = strassen_algorithm(add_matrices(a11, a12), b22);
  Matrix p3 = strassen_algorithm(add_matrices(a21, a22), b11);
  Matrix p4 = strassen_algorithm(a22, subtract_matrices(b21, b11));
  Matrix p5 =
      strassen_algorithm(add_matrices(a11, a22), add_matrices(b11, b22));
  Matrix p6 =
      strassen_algorithm(subtract_matrices(a12, a22), add_matrices(b21, b22));
  Matrix p7 =
      strassen_algorithm(subtract_matrices(a11, a21), add_matrices(b11, b12));
